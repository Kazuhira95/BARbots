...
void AiUpdateEconomy()
{
	...
	aiEconomyMgr.isMetalEmpty = metal.current < metal.storage * 0.15f;
	...
	if (ai.frame < 3 * MINUTE) {
		...
		aiEconomyMgr.isEnergyEmpty = energy.current < energy.storage * 0.15f;
	...
	aiFactoryMgr.isAssistRequired = (metal.current > metal.storage * 0.15f) && !aiEconomyMgr.isEnergyStalling;
}
